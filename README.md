# Speckit for Humans: WYSIWYG Editor
...
![Speckit for Humans Overview](https://raw.githubusercontent.com/agenticminds/speckit-for-humans/4bf7defb6a3e7ee56b34e6dd9dc0a55e471740ec/marketplace-assets/gifs/basic_overview_of_features.gif)
...
Most markdown editors force you to memorize syntax, fight with split panes, or manually manage files. **Speckit for Humans solves the biggest pain points** that make markdown editing frustrating.
...
![Table Editing](https://raw.githubusercontent.com/agenticminds/speckit-for-humans/4bf7defb6a3e7ee56b34e6dd9dc0a55e471740ec/marketplace-assets/gifs/table_operations_with_right_click_menu.gif)
...
![Large Size Image Suggestion](https://raw.githubusercontent.com/agenticminds/speckit-for-humans/4bf7defb6a3e7ee56b34e6dd9dc0a55e471740ec/marketplace-assets/gifs/large_size_image_size_suggestion.gif)
...
![Image Rename Functionality](https://raw.githubusercontent.com/agenticminds/speckit-for-humans/4bf7defb6a3e7ee56b34e6dd9dc0a55e471740ec/marketplace-assets/gifs/image_rename_functionality.gif)
...
![WYSIWYG Editing](https://raw.githubusercontent.com/agenticminds/speckit-for-humans/4bf7defb6a3e7ee56b34e6dd9dc0a55e471740ec/marketplace-assets/gifs/basic_introduction.gif)
...
| Feature                 | Speckit for Humans          | Markdown All in One | Standard Editors  |
| ----------------------- | ---------------------------- | ------------------- | ----------------- |
...
1. Open any `.md` file → Right-click → **"Open with Speckit for Humans"**
2. Start writing!
...
Customize the editor behavior through VS Code settings. Access via `Ctrl+,` (Settings) and search for "Speckit for Humans".

### Image Settings

- **`speckitForHumans.imagePreview.hover.enabled`** (default: `true`)
...
- **`speckitForHumans.imagePath`** (default: `"images"`)
  - Folder path for saved images. Interpreted relative to `speckitForHumans.imagePathBase`.

- **`speckitForHumans.imagePathBase`** (default: `"relativeToDocument"`)
  - Controls whether Image Path is relative to the current markdown file folder or the workspace folder.

- **`speckitForHumans.imageResize.skipWarning`** (default: `false`)
  - Skip the warning dialog when resizing images. When enabled, images will be resized immediately without confirmation.

### PDF Export Settings

- **`speckitForHumans.chromePath`** (default: `""`)
...
![Enhanced Link Feature](https://raw.githubusercontent.com/agenticminds/speckit-for-humans/4bf7defb6a3e7ee56b34e6dd9dc0a55e471740ec/marketplace-assets/gifs/hyperlink_feature.gif)

*Create links easily with support for URLs, file linking, heading links, and more—all through an intuitive dialog interface.*

### Mermaid Diagrams

![Mermaid Diagrams](https://raw.githubusercontent.com/agenticminds/speckit-for-humans/4bf7defb6a3e7ee56b34e6dd9dc0a55e471740ec/marketplace-assets/gifs/mermaid_diagram_with_one_diagram_only.gif)

*Create flowcharts, sequence diagrams, Gantt charts, and more with 15 built-in templates.*

### Document Outline

![Document Outline](https://raw.githubusercontent.com/agenticminds/speckit-for-humans/4bf7defb6a3e7ee56b34e6dd9dc0a55e471740ec/marketplace-assets/gifs/outline_feature_with_sidebar_display.gif)
...
![GitHub Alerts](https://raw.githubusercontent.com/agenticminds/speckit-for-humans/4bf7defb6a3e7ee56b34e6dd9dc0a55e471740ec/marketplace-assets/gifs/github_alerts.gif)
...
Speckit for Humans includes everything you need for a modern writing experience:
...
[Full feature list → Wiki](https://github.com/agenticminds/speckit-for-humans/wiki)
...
We built Speckit for Humans to solve the **real pain points**—tables and images—that make markdown editing frustrating, while keeping the underlying file as plain markdown (so Git diffs, tooling, and other editors still work).
...
- [User Guide](https://github.com/agenticminds/speckit-for-humans/wiki)
- [Known Issues](./KNOWN_ISSUES.md) - Known issues and workarounds
- [Report Issues](https://github.com/agenticminds/speckit-for-humans/issues)
...
> Speckit for Humans exists because open source software empowers everyone. We believe that the best tools should be built, improved, and maintained by the whole community—not limited by a few. By embracing collaboration and transparency, we keep innovation moving forward for everyone.
...
MIT © [Agentic Minds](https://agenticminds.ai)
...
**Made with ❤️ for Markdown lovers, by Team [Agentic Minds**](https://agenticminds.ai)
