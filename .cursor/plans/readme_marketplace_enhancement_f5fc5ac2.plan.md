...
- Side-by-side comparison of traditional markdown vs Speckit for Humans
...
- Show sidebar with "Speckit for Humans: Outline" panel
...
- Columns: "Before (Traditional Markdown)" vs "After (Speckit for Humans)"
