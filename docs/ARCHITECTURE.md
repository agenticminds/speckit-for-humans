# Speckit for Humans - Technical Architecture
...
**Registration:**
- Activates on `onCustomEditor:speckitForHumans.editor` event
...
# → Outputs speckit-for-humans-0.1.0.vsix in the project root
